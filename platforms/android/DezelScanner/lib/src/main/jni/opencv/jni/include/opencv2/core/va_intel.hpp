...
function to create OpenCL layout and set up interoperability.
*/
//! @{
...
/** @brief Creates OpenCL layout from VA.
...
@param size    - size of source represented by VASurfaceID object.
 */
